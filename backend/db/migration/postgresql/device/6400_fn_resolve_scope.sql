--------------UP
-- Single resolver: scope kind + id → device list. Every consumer
-- (Energy.Summary v3, Energy.Query, Report.GenerateReport, alert engine,
-- fleet.GetMetrics) calls this. No inline membership joins anywhere else.
