--------------UP
-- Same plpgsql variable-vs-column ambiguity as organization/6104:
-- RETURNS TABLE (member_type, member_id) collide with target-table cols
-- of the same name inside ON CONFLICT / RETURNING / WHERE.
