...
DROP FUNCTION IF EXISTS organization.fn_group_list(VARCHAR, INTEGER, BOOLEAN, VARCHAR, VARCHAR, INTEGER, INTEGER, VARCHAR, VARCHAR, INTEGER[]);
...
$$;
--------------DOWN
DROP FUNCTION IF EXISTS organization.fn_group_list(VARCHAR, INTEGER, BOOLEAN, VARCHAR, VARCHAR, INTEGER, INTEGER, VARCHAR, VARCHAR, INTEGER[], BOOLEAN, VARCHAR[], INTEGER[], INTEGER[]);
CREATE OR REPLACE FUNCTION organization.fn_group_list(
    p_organization_id VARCHAR,
    p_parent_id       INTEGER   DEFAULT NULL,
    p_roots_only      BOOLEAN   DEFAULT FALSE,
