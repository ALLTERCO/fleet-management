--------------UP
-- Scope-aware insert. Validates that a provided scope subject lives in the
-- same org as the dashboard (cross-org reference → 22023 / CrossOrgReference).
-- At most one of p_location_id / p_group_id / p_tag_id may be set;
-- enforced by the dashboard_scope_single_axis CHECK on the table.
...
$$;
--------------DOWN
DROP FUNCTION ui.fn_dashboard_add_scoped;
