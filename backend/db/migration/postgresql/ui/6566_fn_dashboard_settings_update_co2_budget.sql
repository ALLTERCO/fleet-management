--------------UP
-- Extend fn_dashboard_settings_update with the CO₂ budget.
...
CREATE FUNCTION ui.fn_dashboard_settings_update(
    ...
    p_co2_budget_kg                 DOUBLE PRECISION DEFAULT NULL
)
RETURNS VOID
LANGUAGE plpgsql AS $$
BEGIN
    INSERT INTO ui.dashboard_settings (
        ...
        emission_factor_g_per_kwh, emission_factor_mbm_g_per_kwh, co2_budget_kg
    )
    VALUES (
        p_dashboard_id,
    ...
    ON CONFLICT (dashboard_id) DO UPDATE SET
        ...
        co2_budget_kg                   = COALESCE(p_co2_budget_kg,
                                                   ui.dashboard_settings.co2_budget_kg),
