...
![Provisioning flow: configure the device, it connects, then with a token it is recognized or without one it waits for an operator, and becomes managed](diagrams/provisioning.svg)
