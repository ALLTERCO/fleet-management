<template>
    <PageTemplate title="Control Panel" :tabs="monitoringTabs" fill>
                ...
                <div v-if="store.wsTelemetryEnabled" class="cp-tele-grid">
                    ...
                    <div class="cp-tile">
                        ...
                        <span class="cp-tile-value" :class="rafFrameClass">
                            {{ formatMs(store.wsTelemetryData.rafFrameTimeMaxMs) }}
                        </span>
                    </div>
                </div>
                <div v-if="store.wsTelemetryEnabled" class="cp-tele-grid">
                    ...
                    <div class="cp-tile">
                        ...
                        <span class="cp-tile-value">{{ formatMs(store.wsTelemetryData.shellyDisconnectLatencyMs.p50) }}</span>
                    </div>
                    <div class="cp-tile">
                        <div class="cp-tile-label">Disconnect Latency p95</div>
                        <span class="cp-tile-value">{{ formatMs(store.wsTelemetryData.shellyDisconnectLatencyMs.p95) }}</span>
                    </div>
                    <div class="cp-tile">
                        <div class="cp-tile-label">Disconnect Latency max</div>
                        <span class="cp-tile-value">{{ formatMs(store.wsTelemetryData.shellyDisconnectLatencyMs.max) }}</span>
                    </div>
                    <div class="cp-tile">
                    ...
                    <div class="cp-tile">
                        ...
                        <span class="cp-tile-value">{{ formatMs(store.wsTelemetryData.shellyConnectLatencyMs.p50) }}</span>
                    </div>
                    <div class="cp-tile">
                        <div class="cp-tile-label">Connect Latency p95</div>
                        <span class="cp-tile-value">{{ formatMs(store.wsTelemetryData.shellyConnectLatencyMs.p95) }}</span>
                    </div>
                    <div class="cp-tile">
                        <div class="cp-tile-label">Connect Latency max</div>
                        <span class="cp-tile-value">{{ formatMs(store.wsTelemetryData.shellyConnectLatencyMs.max) }}</span>
                    </div>
                </div>
            </div>
        </BasicBlock>
