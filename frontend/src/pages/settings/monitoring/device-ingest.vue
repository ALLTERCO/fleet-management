<template>
    <PageTemplate title="Device Ingest" :tabs="monitoringTabs" fill>
            ...
            <template v-if="store.obsLevel >= 1 && store.latest">
                ...
                <BasicBlock v-if="store.obsLevel >= 2 && initDurations.length > 0" darker>
                    <div class="di-stack">
                        ...
                        />
                        <MonitoringGrid :columns="4">
                            <StatCard label="Avg Duration" :value="formatMs(initDurationStats.avg)" />
                            <StatCard label="Max Duration" :value="formatMs(initDurationStats.max)" :warn="initDurationStats.max > 5000" />
                            <StatCard label="Min Duration" :value="formatMs(initDurationStats.min)" />
