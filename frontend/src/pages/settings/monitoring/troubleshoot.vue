<template>
    <PageTemplate title="Troubleshoot" :tabs="monitoringTabs" fill>
        <template #actions>
            <Button
        ...
        <ErrorBoundary>
            <div class="ts-layout">
                ...
                <section class="ts-feed">
                    <div v-if="subscriptionError" class="ts-banner">{{ subscriptionError }}</div>
...
const {subscriptionError} = useDeviceEventStream(watchedIds);
