...
export interface HostContract {
    ...
    'entity.getcapabilities': {
        params: {id: string};
        result: {type: string; actions: string[]};
    };
    ...
    /** Read a value by key. */
    'storage.getitem': {params: {key: string}; result: Record<string, unknown>};
    ...
    'storage.keys': {params: Record<string, unknown>; result: string[]};
    ...
    'voltmeter.checkexpression': {
        params: {shellyID: string; expr: string; inputs: number[]};
        result: Record<string, unknown>;
    };
